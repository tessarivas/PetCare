    ...
    while(!WindowShouldClose()){
        ...
        switch(pantalla_actual)
        {
            ...
            case REGISTRAR_PERRO:
            {
                ...
                user.mascotas->addNewMascota(user.mascotas,perro);

                cout<<user.mascotas->Nombre<<endl;
            ...
            case AVATAR_PERRO:
            {
                ...
                Texture2D temporalpa = SeleccionarAvatarPerro(fondo_actual,ANCHO,ALTO);
                cout<<"SALIOOOO"<<endl;
                user.mascotas->DefineAvatar(temporalpa);
            ...
            {
                // cargamos la textura que selecciono el usuario
                user.mascotas->Avatar = SeleccionarAvatarPerro(fondo_actual,ANCHO,ALTO);
